                ...
                {step === 4 && (
                    <div className="fade-in">
                        ...
                        <div style={{ background: 'var(--primary-soft)', padding: '20px', borderRadius: '16px', border: '1px dashed var(--primary)' }}>
                            ...
                            <p style={{ fontSize: '0.9rem', color: '#166534' }}>By clicking finish, your turf <b>{formData.turf_name}</b> will be created and slots will be generated for the next 7 days.</p>
                        </div>
                    </div>
                )}

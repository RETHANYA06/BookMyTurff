...
const PlayerLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post('https://bookmyturff.onrender.com/api/players/login', {
                email,
                password
            });
        ...
        <div className="fade-in" style={{ maxWidth: '400px', margin: '100px auto' }}>
            <div className="glass" style={{ padding: '40px' }}>
                ...
                <p style={{ textAlign: 'center', marginTop: '25px', color: 'var(--text-secondary)' }}>
                    New to BookMyTurf? <Link to="/player-register" style={{ color: 'var(--primary)', fontWeight: 'bold' }}>Register here</Link>
                </p>

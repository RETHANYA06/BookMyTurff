        ...
        <div className="fade-in">
            ...
            <div style={{
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '1.4rem', maxWidth: '800px', margin: '0 auto 60px', fontWeight: '500', lineHeight: '1.4' }}>
                    Access world-class arenas with zero friction. Premium venues, professional-grade quality, instant digital booking.
                </p>
                ...
                <div style={{ maxWidth: '850px', margin: '0 auto', position: 'relative' }}>
                    <div className="glass-heavy" style={{ padding: '12px', borderRadius: '28px', display: 'flex', gap: '15px', border: '1px solid var(--border-subtle)', boxShadow: '0 30px 60px rgba(0,0,0,0.05)' }}>
                        <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center' }}>
                            ...
                            <input
                                placeholder="Locate your next arena..."
                                value={search}
                        ...
                        <button className="btn btn-primary" style={{ height: '65px', padding: '0 45px', fontSize: '1.1rem' }}>Find Arena</button>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '60px' }}>
                    <div>
                        ...
                        <h2 style={{ fontSize: '4.5rem', color: 'var(--text-primary)', marginTop: '15px', marginBottom: '20px' }}>Top <span style={{ color: 'var(--primary)' }}>Arenas</span></h2>
                    </div>
                ...
                <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gap: '35px' }}>
                    {filteredTurfs.slice(0, 6).map(turf => (
                        <div key={turf._id} className="glass card-hover" style={{ overflow: 'hidden', padding: '18px', borderRadius: '32px', border: '1px solid rgba(255,255,255,0.05)' }}>
                            <div style={{
                                height: '280px',
                                background: `linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.7)), url(${turf.image_url || 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=800&auto=format&fit=crop'})`,
                                ...
                                <div style={{ position: 'absolute', bottom: '25px', left: '25px', right: '25px' }}>
                                    <h3 style={{ fontSize: '1.8rem', color: 'white', fontWeight: '800', marginBottom: '5px' }}>{turf.turf_name}</h3>
                                    <p style={{ color: 'rgba(255,255,255,0.7)', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1rem', fontWeight: '600' }}>
                ...
                {filteredTurfs.length === 0 && (
                    <div className="glass" style={{ textAlign: 'center', padding: '120px 40px', borderRadius: '40px' }}>
                        ...
                        <h2 style={{ color: 'white', fontSize: '2.5rem' }}>Arena Not Found</h2>
            ...
            <div className="container" style={{ marginTop: '140px', paddingBottom: '100px' }}>
                <div className="glass-heavy animate-float" style={{
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        ...
                        <h2 style={{ fontSize: '4rem', marginBottom: '25px', color: 'var(--text-primary)', marginTop: '20px', lineHeight: '1' }}>OWN AN ELITE ARENA?</h2>

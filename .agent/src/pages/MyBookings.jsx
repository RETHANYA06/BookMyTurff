    ...
    return (
        <div className="fade-in" style={{ maxWidth: '1000px', margin: '40px auto', paddingBottom: '60px' }}>
            <div style={{ marginBottom: '50px' }}>
                ...
                <h1 style={{ fontSize: '3.5rem', color: 'white', marginTop: '15px', letterSpacing: '-2px', fontWeight: '900' }}>GAME <span className="text-glow" style={{ color: 'var(--primary)' }}>HISTORY</span></h1>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', gap: '30px' }}>
                            <div style={{ flex: 1 }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '25px' }}>
                                    <div>
                                        <h3 style={{ fontSize: '1.8rem', color: 'white', fontWeight: '800', marginBottom: '8px' }}>{booking.turf_id?.turf_name}</h3>
                                    ...
                                    <div style={{ textAlign: 'right' }}>
                                        ...
                                        <div style={{ fontSize: '0.95rem', fontWeight: '900', color: 'white', letterSpacing: '1px' }}>#{booking._id.slice(-8).toUpperCase()}</div>
                                    </div>
                                </div>
                                ...
                                <div className="grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px', background: 'rgba(255,255,255,0.02)', padding: '25px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)', marginBottom: '30px' }}>
                                    <div>
                                        ...
                                        <div style={{ fontWeight: '900', fontSize: '0.9rem', color: 'white' }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontWeight: '900', fontSize: '0.9rem', color: 'white', display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            ...
                                            <span style={{ fontWeight: '900', fontSize: '0.8rem', textTransform: 'uppercase', color: 'white', letterSpacing: '1px' }}>
                                    ...
                                    <div style={{ marginBottom: '30px', padding: '20px', background: 'rgba(16, 185, 129, 0.05)', borderRadius: '20px', border: '1px solid rgba(16, 185, 129, 0.1)' }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                                            {booking.rental_items.map(ri => (
                                                <div key={ri._id} style={{ fontSize: '0.85rem', color: 'white', background: 'rgba(255,255,255,0.05)', padding: '6px 15px', borderRadius: '10px', fontWeight: '700', border: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                {filteredBookings.length === 0 && (
                    <div className="glass-heavy" style={{ textAlign: 'center', padding: '120px 40px', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <div style={{ fontSize: '5rem', marginBottom: '25px', opacity: 0.3 }}>🏟️</div>
                        <h2 style={{ fontSize: '2.5rem', color: 'white', fontWeight: '900', letterSpacing: '-1px' }}>No Match Records</h2>
                        ...
                        <button className="btn btn-primary" style={{ marginTop: '40px', padding: '18px 45px' }} onClick={() => window.location.href = '/player/dashboard'}>Browse Arenas</button>
                    </div>
                )}
            </div>
        </div>
